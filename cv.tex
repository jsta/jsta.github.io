...
\begin{bibenum}
    ...
    \item \textbf{Stachelek J.}, Madden, C.J., Kelly, S.P, Blaha, M. (\emph{submitted}). Fine-scale relationships between phytoplankton abundance and environmental drivers in Florida Bay, USA.
...
\vspace{1em}
  ...
  \begin{innerlist}
    ...
    \item \href{https://github.com/jsta/wikilake}{wikilake: Scrape Lakes Metadata Tables from Wikipedia}
  \end{innerlist}
  
  \emph{Contributor}
  \begin{innerlist}
    \item \href{https://github.com/ropensci/rnoaa}{rnoaa: 'NOAA' Weather Data from R.}
    \item \href{https://github.com/jhollist/lakemorpho}{lakemorpho: Lake Morpometry Metrics in R.}
  \end{innerlist}
