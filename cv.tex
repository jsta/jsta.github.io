...
\begin{bibenum}
    ...
    \item \textbf{Stachelek J.}, Madden, C.J., Kelly, S.P, Blaha, M. (\emph{in-prep}). Fine-scale relationships between phytoplankton abundance and environmental drivers in Florida Bay, USA.
   
   \item \textbf{Stachelek J.}, Kelly, S.P, Sklar, F., Coronado, C.M., Troxler, T., Bauman, L. (\emph{in-prep}). A mesocosm design for simulating sea-level rise associated saltwater intrusion in coastal wetlands.
