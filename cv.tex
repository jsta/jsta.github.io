...
\begin{outerlist}
\item[] Additional Courses and Training
\end{outerlist}
...
\item[] \textit{Instructor}
    ...
    \begin{innerlist}
        \item Delivered workshops (2) to teach basic lab skills for research computing
    \end{innerlist}
...
\href{http://www.osu.edu/}{\textbf{University of Texas Marine Science Institute}},
Port Aransas, TX
\begin{outerlist}
...
\vspace{1em}
  ...
  \begin{innerlist}
    ...
    \item \href{https://github.com/SFWMD/dbhydroR}{dbhydroR: Everglades Hydrologic and Water Quality Data from R.}
  \end{innerlist}
