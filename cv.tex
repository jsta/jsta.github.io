...
\item[] B.S.,
        ...
        \begin{innerlist}
        \item Thesis: \emph{\href{http://www.nps.gov/acad/naturescience/upload/FieldGuidetoMarinePlantsAlgae.pdf}{Constructing a guide to the Intertidal Algae of Acadia National Park and testing DNA barcoding}}
        \item Adviser:
...
\vspace{1em}
\href{}{\textbf{Additional Courses and Training}},
...
\item[] \textit{Instructor}
    ...
    \begin{innerlist}
        \item Delivered workshops (1) to teach basics of the Linux command line for research computing (Institute for Cyber-enabled Research)
    \end{innerlist}
